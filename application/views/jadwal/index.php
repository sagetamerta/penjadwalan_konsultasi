        ...
        <div class="col-lg-6">
            ...
            <form action="<?= base_url('psikolog/addjadwal'); ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="popsize" id="popsize" placeholder="ex : 10">
                    <small>Banyak populasi yang akan dibuat (popsize)</small>
                </div>
                <div class="form-group">
                    <label for="cr">Crossover Rate</label>
                    <input type="number" class="form-control" name="cr" id="cr" step="0.01" placeholder="ex : 0.5">
                    <small>Nilai untuk persilangan (crossover)</small>
                </div>
                <div class="form-group">
                    <label for="mr">Mutation Rate</label>
                    <input type="number" class="form-control" name="mr" id="mr" step="0.01" placeholder="ex : 0.5">
                    <small>Nilai untuk mutasi (mutation)</small>

                </div>
                <div class="form-group">
                    <label for="iterasi">Iterasi</label>
                    <input type="number" class="form-control" name="iterasi" id="iterasi" placeholder="ex : 1000">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="thresholdSaget" id="thresholdSaget" placeholder="ex : 0.07" step="0.01">
